	...
	public void openConnection() {
		...
		try {
			//Class.forName("com.mysql.jdbc.Driver");
		      ...
		      connection = DriverManager.getConnection("jdbc:google:rdbms://xochimilcoccm:xochimilco/xochimilco");
			//connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/xochimilco","xochimilco","uno");
